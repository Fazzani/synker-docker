...
sed -i "s/smtp_auth_password/${SENDGRID_API_KEY}/g" synker-docker/monitoring/alertmanager/alertmanager.yml
sed -i "s/slack_api_url/${SENDGRID_API_URL_MONITORING}/g" synker-docker/monitoring/alertmanager/alertmanager.yml
